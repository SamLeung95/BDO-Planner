...
$scripts["items"]["secondary-weapons"]["musa"] = "items/secondary-weapons/bow.json";
$scripts["items"]["secondary-weapons"]["maehwa"] = "items/secondary-weapons/bow.json";
$scripts["items"]["secondary-weapons"]["ninja"] = "items/secondary-weapons/shuriken.json";
$scripts["items"]["secondary-weapons"]["kunoichi"] = "items/secondary-weapons/kunoichi.json";
